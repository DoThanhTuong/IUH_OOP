...
class HangThucPham extends HangHoa {
    ...
    public String toString() {
        ...
        return super.toString() + String.format("| Nhà cung cấp: %-15s| Ngày sản xuất: %-15s| Ngày hết hạn: %-15s",
                nhaCungCap, ngaySanXuat.format(formatter), ngayHetHan.format(formatter));
    }
}