...
class HangSanhSu extends HangHoa {
    ...
    public String toString() {
        ...
        return super.toString() + String.format("| Nhà sản xuất: %-15s| Ngày nhập kho: %-15s\t\t\t\t| Đánh Giá Bán Buôn: %-15s| VAT: %-15f",
                nhaSanXuat, ngayNhapKho.format(formatter),danhGiaBanBuon(),tinhVAT());
    }
}