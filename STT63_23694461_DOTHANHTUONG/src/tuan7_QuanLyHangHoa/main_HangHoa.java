...
public class main_HangHoa {
	public static void main(String[] args) throws IllegalAccessException {
		...
		do {
			...
			System.out.println("4. Xuất các Hàng Thực Phẩm khó bán");
			...
			switch (chon) {
				case 1:
					...
					break;
				case 2:
					HangHoa[] danhSachToanBo = ds.hienThiDanhSach();
				    for (HangHoa hang : danhSachToanBo) {
				...
				case 3:
					...
					break;
				case 4:
					for(HangThucPham htp : ds.hienThiHangThucPhamKhoBan()) {
				...
				case 9:
				    ...
				    HangHoa[] danhSachSanhSu = ds.hienThiHangSanhSu();
				    for (HangHoa hang : danhSachSanhSu) {
				        System.out.println(hang);
				    }
				    break;
				case 10:
				    System.out.println("Danh sách Hàng Điện Máy.");
				    HangHoa[] danhSachDienMay = ds.hienThiHangDienMay();
				    for (HangHoa hang : danhSachDienMay) {
				        System.out.println(hang);
				    }
				    break;
				case 11:
				    System.out.println("Danh sách Hàng Thực Phẩm.");
				    HangHoa[] danhSachThucPham = ds.hienThiHangThucPham();
				    for (HangHoa hang : danhSachThucPham) {
				        System.out.println(hang);
				    }
				    break;
