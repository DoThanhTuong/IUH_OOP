package tuan2_quanLySinhVienDonGian;
...
public class KiemThuSV {
    ...
    public static void main(String[] args) {
        ...
        SinhVien sv4 = new SinhVien(0, null, 0f, 0f);
        SinhVien sv5 = new SinhVien(0, null, 0f, 0f);
        SinhVien sv6 = new SinhVien(0, null, 0f, 0f);
